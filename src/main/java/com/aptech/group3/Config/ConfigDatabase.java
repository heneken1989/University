 ...
 * 
 * @Configuration public class ConfigDatabase {
 * 
 * @Value("${db.datasource.driverClassName}") private String driverClassName;
 * 
 * @Value("${db.datasource.url}") private String urlDB;
 * 
 * @Value("${db.datasource.username}") private String userName;
 * 
 * @Value("${db.datasource.password}") private String password;
 * 
 * @Bean(name = "dataSource") public DataSource dataSource() { HikariConfig
 * hikariConfig = new HikariConfig(); hikariConfig.setJdbcUrl(urlDB);
 * hikariConfig.setDriverClassName(driverClassName);
 * hikariConfig.setUsername(userName); hikariConfig.setPassword(password);
 * 
