...
$("#first_week_schedule").attr("href",`${baseUrlTimeTable}/time_table/show?semester=${currentSemester}&week=1`)
if(currentWeek!=1){
$("#previous_week_schedule").attr("href",`${baseUrlTimeTable}/time_table/show?semester=${currentSemester}&week=${currentWeek-1}`)
}
if(currentWeek<list.length){
	$("#next_week_schedule").attr("href",`${baseUrlTimeTable}/time_table/show?semester=${currentSemester}&week=${currentWeek+1}`)
}
$("#last_week_schedule").attr("href",`${baseUrlTimeTable}/time_table/show?semester=${currentSemester}&week=${list.length}`)
